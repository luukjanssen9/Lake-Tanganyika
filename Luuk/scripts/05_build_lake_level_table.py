...
Exogenous drivers:
    era5_download/csv_monthly/era5_grid_*_monthly.csv   (ERA5 catchment cells)
    station_level_v2/station_level_v2/*.csv             (12 river-level stations)

Output:
    data/processed/lake_tanganyika_modeling_table.csv

Usage:
    python scripts/05_build_lake_level_table.py
"""
...
ERA5_DIR   = REPO_ROOT / "era5_download" / "csv_monthly"
RIVERS_DIR = REPO_ROOT / "station_level_v2" / "station_level_v2"
