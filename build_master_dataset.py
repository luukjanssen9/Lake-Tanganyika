...
HYDRO_METEO_DIR = ROOT / "Lake Tanganyika Data" / "Donnees Hydro et Meteo Mensuelles_IGEBU"
NEW_DATA_DIR = next((ROOT / "Lake Tanganyika Data").glob("*nouvelles*"), None)
ERA5_DIR = ROOT / "era5_download" / "csv"
