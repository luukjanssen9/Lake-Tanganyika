...
Run:
    python report_figures/make_report_figures.py
"""
...
def dahiti_trend_figure() -> None:
    ...
    # Linear trend in metres per year (x = fractional years since first obs).
    t0 = df["date"].iloc[0]
