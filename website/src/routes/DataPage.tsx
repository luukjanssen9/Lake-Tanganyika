...
const researchDataCards: ResearchDataCard[] = [
  ...
  {
    name: "River-level outputs",
    description:
      "River-specific outputs generated by the team, including raw water-level records before imputation, imputation uncertainty estimates, and prediction forecasts for individual rivers.",
    source: "Project river graph outputs",
    usedFor: "River analysis graphs, map-linked river plots, and river-level forecast comparison.",
    matchers: [
      "data/river_graph_outputs/ALL_raw_no_imputation.csv",
      "data/river_graph_outputs/ALL_imputation_uncertainty.csv",
      "data/river_graph_outputs/ALL_prediction_forecasts.csv",
    ],
  },
];
